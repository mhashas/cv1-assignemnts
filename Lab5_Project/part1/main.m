...
vocabulary_images = 200; % number of images used for building the visual vocabulary
training_images_per_class = 200; % number of images for training the svm classifier
